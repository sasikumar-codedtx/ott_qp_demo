...
enum AppStrings {
    ...
    enum Profile {
        ...
        static let namePlaceholder = "Profile name"
        static let preferredContent = "Preferred content"
        static let kidsProfile = "Kids profile"
        static let selectAvatar = "Select Avatar"
        ...
        static let flipkart = "Subscribe with Flipkart Supercoins"
...
enum AppIcons {
    enum Navigation {
        ...
        static let library = "arrow.down.circle"
